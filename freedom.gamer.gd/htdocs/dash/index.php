...
<body>
  ...
  <div id="login"   class="content active"><div class="box">
    <h2>Login GDPS</h2>
  ...
  <div id="search"  class="content"><div class="box">
    <h2>Cari Level</h2>
  ...
  <div id="featured" class="content"><div class="box">
    <h2>🔥 Featured Level</h2>
    <div id="feat-res">Memuat…</div>
  </div></div>

  <div id="stats"   class="content"><div class="box">
    <h2>📊 Server Stats</h2>
    <div id="stats-res">Memuat…</div>
  </div></div>

  <div id="profile" class="content"><div class="box">
    <h2>👤 Profile User</h2>
  ...
  <div id="addSong" class="content"><div class="box">
    <h2>🎵 Upload Song</h2>
  ...
  <div id="makePost" class="content"><div class="box">
    <h2>✏️ Buat Post</h2>
  ...
  <div id="whoRated" class="content"><div class="box">
...
document.addEventListener("DOMContentLoaded",()=>{
  ...
  document.getElementById('btnAddSong').onclick = ()=>{
    fetch(api+'addSong.php',{method:'POST',
      headers:{'Content-Type':'application/x-www-form-urlencoded'},
  ...
  document.getElementById('btnMakePost').onclick = ()=>{
    fetch(api+'makePost.php',{method:'POST',
      headers:{'Content-Type':'application/x-www-form-urlencoded'},
